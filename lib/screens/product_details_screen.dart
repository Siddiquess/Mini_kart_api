...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<void> getProduct() async {
    try {
      productsModel = await Provider.of<ProductsModel>(context).getProduct(widget.id);
    } catch (error) {
      log('============= $error');
      if (mounted) {
        Provider.of<ProductsModel>(context, listen: false).dataError();
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Provider.of<ProductsModel>(context).isError
          ? const Center(
              child: Text('Error fount'),
            )
          : productsModel == null
              ? const Center(
